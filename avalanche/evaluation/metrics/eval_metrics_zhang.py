...
def main():
    ...
    # scoreFile = "../models/e.txt"
    # labelFile = "./database/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.eval.trl.txt"
    # asvlabel = "./database//ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt"
    scoreFile = "./models/bimam_64_12_1/19LA_eval.txt"

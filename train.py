...
for strate in method_query:
    for current_mode in ['offline']:
        ...
        if args.pretrain_feature=='None':
            ...
            # model = clearMLP()
            # model = SimpleMLP(num_classes=2, input_size= args.pretrain_feature, hidden_size=512, hidden_layers=1, drop_rate=0.1)
    ...
    os.makedirs("../{}/eer".format(args.split), exist_ok = True)
    with open("../{}/eer/{}.txt".format(args.split, strate), "w") as file:
    ...
    print("==============> Saving EER Result on {}".format("../{}/eer/{}.txt".format(args.split, strate)))
    plot_eer_dict(cl_strategy.eer_record, "../{}/eer/{}/".format(args.split, strate))
    print("==============> Ploted EER Result on {}".format("../{}/eer/{}/".format(args.split, strate)))
    print("==============> Saved <===============")
exit()